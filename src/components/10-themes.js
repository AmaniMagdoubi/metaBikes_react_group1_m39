        ...
        <ThemeWrapper>
            <div className="theme_modal">
              ...
              <div className="colour_links">
                        ...
                        {/* Theme 3 - "Red" Honda */}
                        <div className="colour_drop red_theme" onClick={() => {themeOff(); changeText1(''); changeText2('');changeBackground('000'); changeAccent('#DC182D'); changeOutline('#979797'); changeBtn('#DC182D'); changeHL('#979797'); changeHeading(''); changeLink('');}}></div>
                           
                        {/* Theme 4 - "Grey" */}
                        <div className="colour_drop grey_theme" onClick={() => {themeOff(); changeText1(''); changeText2('');changeBackground(''); changeAccent('#9da8a9'); changeOutline('#5a5a5d'); changeBtn('#abb8c3'); changeHL('#2e3c41'); changeHeading(''); changeLink('');}}></div>
