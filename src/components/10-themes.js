...
import {GNavWrapper, LeftSpace, RightMainWrapper, Row} from "../styles/global.styles.js"; //Global wrapper styles
...
const Themes = ({modalShow, modalOff}) => {
    ...
    function changeText1 (newColorText1){
        document.documentElement.style.setProperty('--clr-text-dark', newColorText1);
    }
    function changeText2 (newColorText2){
        document.documentElement.style.setProperty('--clr-text-light', newColorText2);
    }
    function changeBackground (newColorBackground){
        document.documentElement.style.setProperty('--clr-background', newColorBackground);
    }
