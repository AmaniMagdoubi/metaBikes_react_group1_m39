                      ...
                      <p>FOLLOW US ON SOCIALS:
                        <div className="footer_icons">
                          ...
                          <a href="https://en-gb.facebook.com/" target="_blank" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 30 30" width="30px" height="30px" className="facebook_icon">    
                          ...
                          <a href="https://www.instagram.com/" target="_blank" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 30 30" width="30px" height="30px" className="instagram_icon">    
                          ...
                          {/* Twitter Icon SVG */}
                          <a href="https://twitter.com/?lang=en-GB" target="_blank" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 30 30" width="30px" height="30px" className="twitter_icon">    
